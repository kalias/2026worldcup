    ...
    matches: [
      ...
      },
      {
        ...
        rationale: {
          ...
          verdict: "预测：阿根廷晋级",
          points: [
            "梅西的最后一舞——卫冕冠军的核心战意与大赛气场无与伦比，淘汰赛关键战决定性极强。",
            "英格兰攻击群（凯恩、贝林厄姆、萨卡）火力强劲，但后防面对阿根廷的灵活穿插易露破绽。",
            "阿根廷淘汰赛抗压能力顶级，2022 决赛逆转法国已证明其韧性；马丁内斯（大马丁）是定海神针。",
          ],
          reasoning: "强强对话，梅西的个人闪光 + 阿根廷的大赛底蕴更胜一筹，预测阿根廷 2-1 晋级。",
        },
      },
    ],
  },
