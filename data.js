...
const ROUNDS = [
  ...
  },
  {
    ...
    matches: [
      ...
      {
        a: "England", b: "Norway", sa: 2, sb: 1, winner: "England", status: "pred",
        rationale: {
          title: "英格兰 🆚 挪威",
          verdict: "预测：英格兰晋级",
          points: [
      ...
      {
        a: "Argentina", b: "Switzerland", sa: 2, sb: 1, winner: "Argentina", status: "pred",
        rationale: {
          title: "阿根廷 🆚 瑞士",
          verdict: "预测：阿根廷晋级",
          points: [
  ...
  },
  {
    ...
    matches: [
      {
        a: "France", b: "Spain", sa: 2, sb: 1, winner: "France", status: "pred",
        rationale: {
          title: "法国 🆚 西班牙",
          verdict: "预测：法国晋级",
          points: [
            "法国 1/4 决赛 2-0 干净利落淘汰摩洛哥，姆巴佩进球+防线零封，攻防两端状态拉满。",
            "西班牙 1/4 决赛 2-1 力克比利时，亚马尔、法比安建功，但被德布劳内破门暴露高位防线身后空当。",
            "法国锋线姆巴佩的速度正中西班牙高位防线的软肋——西班牙敢压上就敢被打身后。",
            "历史：近几届大赛法国对西班牙战绩占优（如 2021 欧国联决赛法国 2-1 胜）。",
          ],
          reasoning: "西班牙控球占优但身后空当会被姆巴佩惩罚，法国反击效率更高，预测法国 2-1 晋级。",
        },
      },
      {
        a: "England", b: "Argentina", sa: 1, sb: 2, winner: "Argentina", status: "pred",
        rationale: {
          title: "英格兰 🆚 阿根廷",
          verdict: "预测：阿根廷晋级",
          points: [
            "梅西的最后一舞——卫冕冠军的核心战意与大赛气场无与伦比，淘汰赛关键战决定性极强（本届已 4 球）。",
            "英格兰攻击群（凯恩、贝林厄姆、萨卡）本届已合力轰入 8 球，火力强劲，但后防在面对阿根廷的灵活穿插时易露破绽（16 强对墨西哥失 2 球）。",
            "阿根廷淘汰赛抗压能力顶级，2022 决赛逆转法国已证明其韧性；马丁内斯（大马丁）的点球扑救能力是半决赛保险阀。",
          ],
          reasoning: "火星撞地球的对攻战，英格兰能进球但阿根廷的大赛底蕴和梅西的瞬间闪光更致命，预测阿根廷 2-1 晋级。",
        },
      },
    ],
  },
