    ...
    matches: [
      {
        ...
        rationale: {
          ...
          verdict: "预测：阿根廷夺冠",
          points: [
            "梅西的最后一舞——卫冕冠军核心战意拉满，本届已 4 球，半决赛 2-1 力克英格兰展现冠军相。",
            "西班牙半决赛 2-0 完胜法国（爆冷淘汰夺冠大热），亚马尔、法比安状态爆棚，是 2024 欧洲杯冠军，实力不容小觑。",
            "中场之争是胜负手：西班牙罗德里+佩德里的控球 vs 阿根廷恩佐+麦卡利斯特的反抢，风格相克——阿根廷能用逼抢打断西班牙节奏。",
            "阿根廷连续打加时体能存隐患，但马丁内斯（大马丁）的扑救/点球能力是决赛保险阀；西班牙防线高位压上，梅西+阿尔瓦雷斯可抓身后空当。",
          ],
          reasoning: "控球权可能归西班牙，但阿根廷的效率与大赛底蕴更胜一筹——梅西的圆满执念决定比赛，预测阿根廷 2-1 夺冠。",
        },
      },
    ],
  },
