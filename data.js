    ...
    matches: [
      {
        ...
        rationale: {
          ...
          verdict: "预测：阿根廷夺冠（加时）",
          points: [
            "2022 决赛重演——阿根廷点球胜法国，心理与战术记忆俱在；梅西本届已 4 球，最后一舞战意拉满。",
            "法国本届淘汰赛展现统治力（QF 2-0 零封摩洛哥、16强 1-0 力克巴拉圭），姆巴佩状态爆棚，是阿根廷最大威胁。",
            "阿根廷连续加时（32强、QF）体能是隐患，但马丁内斯（大马丁）的大赛扑救/点球能力是最终保险阀。",
            "两队中场（恩佐/麦卡利斯特 vs 琼阿梅尼/卡马文加）旗鼓相当，胜负手在梅西 vs 姆巴佩的巨星闪光。",
          ],
          reasoning: "史诗级重演，姆巴佩能进球但阿根廷的大赛底蕴+梅西的圆满执念更胜一筹，预测阿根廷 2-1 加时夺冠。",
        },
      },
    ],
  },
